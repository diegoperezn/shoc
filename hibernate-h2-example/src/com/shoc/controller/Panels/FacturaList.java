 ...
 * @author diego
 */
public class FacturaList extends javax.swing.JPanel {
    ...
    public FacturaList() {
        ...
        fillTable(service.generarYlistarFacuraDetails());
    }
    ...
    private void fillTable(List<FacturaDetail> list) {
        ...
        list.forEach((cuenta) -> {
            model.addRow(new Object[]{cuenta.getId(), cuenta.getFecha()
            }
            );
        });
    }
    ...
    private void initComponents() {
        ...
        tableCuentas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Fecha", "Paciente", "Obra Social", "Dispositivo", "Dias", "Costo dipositivo", "Monto"
            }
        ) {
